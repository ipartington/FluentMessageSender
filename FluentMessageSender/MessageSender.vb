...
Imports FluentMessageSender.Interfaces
...
Public Class MessageSender
    ...
    Public Class SendExpression
        ...
        Public Function From(ByVal sender As FromAddress) As IToExpression
            _sender = sender
            Return Me
        End Function

        Public Sub ToExpression(ByVal receiver As String) Implements IToExpression.[To]
